...
This repository contains the course material of our [useR! 2021 tutorial](https://user2021.r-project.org/).

Instructors: [Sébastien Rochette](https://statnmap.com), [Emily Riederer](emily.rbind.io)
...
- courses/C01-package_express_fusen.en.Rmd: Build a package using {fusen}
