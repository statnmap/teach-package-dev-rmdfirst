...
- Draw a schematic view of the links between "flat_teaching.Rmd" content and package structure
- Explore the multiple files and folders created
- Can you spot where each part of the "flat_teaching.Rmd" went?
...
- Your "dev_history.Rmd" file should look like this:
