...
- Look at the instructor demonstration
- Do it yourself
...
- Clean the "median" and "mean" example sections
...
- Create a reproducible example using the dataset saved in `inst` using `system.file()`
