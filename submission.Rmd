...
How to build a package with Rmd Driven Development

## Abstract

"Rmd Driven Development" can reduce mental load when building packages by keeping users in a natural environment, using a tool they know : a RMarkdown document. 
...
We will take advantage of all existing tools such as {devtools}, {testthat}, and {usethis} that ease package development from Rmd to building a package.
...
Attendees will leave this workshop having built their first package with the Rmd Driver Development method and with the skills and tools to build more packages on their own.
